...
class RJ_window_class:
    ...
    def set_default_values(self):
        ...
        if self.single_multi_selected_button=="single":
            ...
            M0_default= 2   #bcz what if it is not selected as independent variable
            min_M0_default= 1
            steps_M0_default= 5
            max_M0_default= 2.5
        M6_default= "NA"
        ...
        if self.single_multi_selected_button=="single":
            ...
            min_Tt4_default= 1600
            steps_Tt4_default= 5
            max_Tt4_default= 2000
        Tt7_default= "NA"
    ...
    def set_iteration_variables_frame(self):
        ...
        if self.onetwo_indp_var.get()=="one":
            ...
            self.indep_var_entry_combobox= ttk.Combobox(self.iteration_variables_frame,values=["Tt4","alt","M0"],state="readonly")
            ...
            self.indep_var1_entry_combobox= ttk.Combobox(self.iteration_variables_frame,values=["Tt4","alt","M0"],state="readonly")
            ...
            self.indep_var2_entry_combobox= ttk.Combobox(self.iteration_variables_frame,values=["Tt4","alt","M0"],state="readonly")
    ...
    #nomenclature_img label frame 
        ...
        # img= Image.open("\\".join(os.path.abspath(__file__).split("\\")[0:-1]) +"\\images\\ramjet_nomenclature_img.png")
        img= Image.open(resource_path("MAIN_GUI\\images\\ramjet_nomenclature_img.png"))
    ...
    def pca_results_vs_station_properties_checkbutton_command(self,event=None):  #bcz we are calling this function from the index_entry widget hence we need 
        ...
        #epa_test_button widget
        epa_test_button= ttk.Button(self.wrapper_tree_frame,text="Test this engine",command= self.epa_test_button_command)
